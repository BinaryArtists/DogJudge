...
K_PJS_PATH = "/Users/f7/anaconda2/pkgs/phantomjs-2.1.1-0/bin/phantomjs"
...
class SpiderBdImg(object):
    ...
    def __init_work(self, a_proxy):
        try:
            ...
            print '[Process] Web driver is get at '+IMAGE_SERVER
    ...
    def search_img_by_name(self, a_name):
        ...
        print '[Process]search img on testing search input label'
        ...
        print '[Process]search img on testing search button'
